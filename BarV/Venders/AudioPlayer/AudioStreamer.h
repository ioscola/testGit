...
{
	AS_NO_ERROR = 0,
	AS_NETWORK_CONNECTION_FAILED = 1,
	AS_FILE_STREAM_GET_PROPERTY_FAILED = 2,
	AS_FILE_STREAM_SEEK_FAILED = 3,
	AS_FILE_STREAM_PARSE_BYTES_FAILED = 4,
	AS_FILE_STREAM_OPEN_FAILED = 5,
	AS_FILE_STREAM_CLOSE_FAILED = 6,
	AS_AUDIO_DATA_NOT_FOUND = 7,
	AS_AUDIO_QUEUE_CREATION_FAILED = 8,
	AS_AUDIO_QUEUE_BUFFER_ALLOCATION_FAILED = 9,
	AS_AUDIO_QUEUE_ENQUEUE_FAILED = 10,
	AS_AUDIO_QUEUE_ADD_LISTENER_FAILED = 11,
	AS_AUDIO_QUEUE_REMOVE_LISTENER_FAILED = 12,
	AS_AUDIO_QUEUE_START_FAILED = 13,
	AS_AUDIO_QUEUE_PAUSE_FAILED = 14,
	AS_AUDIO_QUEUE_BUFFER_MISMATCH = 15,
	AS_AUDIO_QUEUE_DISPOSE_FAILED = 16,
	AS_AUDIO_QUEUE_STOP_FAILED = 17,
	AS_AUDIO_QUEUE_FLUSH_FAILED = 18,
	AS_AUDIO_STREAMER_FAILED = 19,
	AS_GET_AUDIO_TIME_FAILED = 20,
	AS_AUDIO_BUFFER_TOO_SMALL = 21
